...
export default class aboutsPreview extends React.Component {
  render() {
    ...
    const entryabouts = entry.getIn(["data", "abouts"]);
    const abouts = entryabouts ? entryabouts.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {abouts.map(({text, heading, imageUrl}, i) =>
